import { Button, useColorModeValue, Icon, Stack, Text, FormControl, FormLabel, Input } from "@chakra-ui/react";
      ...
      <div style={{ display: "flex", width: "75%", margin: "auto" }}>
            ...
            <div>
              <div>
                <FormControl>
                  ...
                  <Input size="lg" marginBottom="20px" type="email" onChange={(e)=>setEmail(e.target.value)} />
                </FormControl>
              </div>
              <div>
                {loginformopen()}
              ...
              <div>
                <Stack textAlign="center">
                  ...
                  <Text lineHeight="5">
                    <span style={{ color: "#3b93e1" }}>Resend the email</span>.
                  </Text>
                </Stack>
              </div>
            </div>
        ...
        <div style={{ width: "40%" }}>
          ...
          <div>
            <img
              width="83%"
              src="https://assets.mailtrap.io/packs/assets/landing/login-fb2fcb15feb36d8e9356.svg"
              alt="129"
            />
          </div>
          ...
          >
            <div>
              <Text fontSize="md" fontWeight="700">
                Mailtrap is great for testing of email notifications that
              </Text>
            </div>
          </div>
          ...
          >
            <div>
              <Text fontSize="md" fontWeight="700">
                are scheduled to go to many users.
              </Text>
            </div>
          </div>
        </div>
